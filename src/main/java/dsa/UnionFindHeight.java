 ...
 * On 2020/2/18 22:21
 */
public class UnionFindHeight {

  private int[] parent;
  private int[] height;
  int size;

  public UnionFindHeight(int size) {
    this.size = size;
  ...
  public static void main(String[] args) {
    int n = 10;
    UnionFindHeight union = new UnionFindHeight(n);
